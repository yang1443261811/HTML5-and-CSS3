(function () {
  ...
  Preview.prototype = {
    ...
    init: function () {
      ...
      console.log('elemPreviewImg:' + this.elemPreviewImg.offsetWidth)
      ...
      function preview(e) {
        ...
        if (tag !== 'img') return;
        console.log('elemPreviewImg:' + _this.elemPreviewImg.offsetWidth);
        ...
        console.log('moveObj:' + _this.moveObj)
